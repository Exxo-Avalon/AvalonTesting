...
public class BactusMinion : ModNPC
{
    ...
    public override void ModifyNPCLoot(NPCLoot npcLoot)
    {
        if (NPC.AnyNPCs(ModContent.NPCType<BacteriumPrime>()))
        {
            ...
            {
                Item.NewItem(NPC.GetSource_Loot(), (int)NPC.position.X, (int)NPC.position.Y, NPC.width, NPC.height, ModContent.ItemType<Booger>(), Main.rand.Next(1, 4), false, 0, false);
            }
            if (Main.rand.Next(3) != 0)
            {
                Item.NewItem(NPC.GetSource_Loot(),(int)NPC.position.X, (int)NPC.position.Y, NPC.width, NPC.height, ModContent.ItemType<BacciliteOre>(), Main.rand.Next(4, 11), false, 0, false);
            }
            ...
            {
                Item.NewItem(NPC.GetSource_Loot(),(int)NPC.position.X, (int)NPC.position.Y, NPC.width, NPC.height, ItemID.Heart, 1, false, 0, false);
            }
        }
    }
