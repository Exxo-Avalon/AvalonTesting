...
public class IronSlime : ModNPC
{
    ...
    public override void SetDefaults()
    {
        ...
        Banner = NPC.type;
        BannerItem = ModContent.ItemType<IronSlimeBanner>();
    }

    public override void ModifyNPCLoot(NPCLoot npcLoot) => npcLoot.Add(ItemDropRule.Common(ItemID.IronOre, 1, 15, 25));
    ...
    public override float SpawnChance(NPCSpawnInfo spawnInfo) =>
        ...
        (Main.hardMode || WorldGen.SavedOreTiers.Iron == TileID.Iron)
