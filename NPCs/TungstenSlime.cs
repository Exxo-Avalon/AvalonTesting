...
public class TungstenSlime : ModNPC
{
    ...
    {
        return spawnInfo.player.ZoneRockLayerHeight && !spawnInfo.player.ZoneDungeon && (Main.hardMode || WorldGen.SavedOreTiers.Silver == TileID.Tungsten) ? 0.00526f * AvalonTestingGlobalNPC.endoSpawnRate : 0f;
    }
}
