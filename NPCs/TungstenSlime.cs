...
public class TungstenSlime : ModNPC
{
    ...
    public override void SetDefaults()
    {
        ...
        Banner = NPC.type;
        BannerItem = ModContent.ItemType<TungstenSlimeBanner>();
    }
    ...
    public override void ModifyNPCLoot(NPCLoot loot) => loot.Add(ItemDropRule.Common(ItemID.TungstenOre, 1, 15, 25));
    ...
    public override float SpawnChance(NPCSpawnInfo spawnInfo) =>
        ...
        (Main.hardMode || WorldGen.SavedOreTiers.Silver == TileID.Tungsten)
