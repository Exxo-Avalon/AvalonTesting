...
public class LeadSlime : ModNPC
{
    ...
    public override void SetDefaults()
    {
        ...
        Banner = NPC.type;
        BannerItem = ModContent.ItemType<LeadSlimeBanner>();
    }

    public override void ModifyNPCLoot(NPCLoot npcLoot) => npcLoot.Add(ItemDropRule.Common(ItemID.LeadOre, 1, 15, 25));
    ...
    public override float SpawnChance(NPCSpawnInfo spawnInfo) =>
        ...
        (Main.hardMode || WorldGen.SavedOreTiers.Iron == TileID.Lead)
