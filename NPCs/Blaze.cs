...
public class Blaze : ModNPC
{
    ...
    public override void PostDraw(SpriteBatch spriteBatch, Vector2 vector, Color drawColor)
    {
        ...
        Main.spriteBatch.Draw(Mod.Assets.Request<Texture2D>("Sprites/BlazeGlow").Value,
            new Vector2(
    ...
    public override void AI()
    {
        ...
        if (Main.rand.Next(20) == 0)
        {
            ...
            Dust? dust56 = Main.dust[num1225];
            dust56.velocity.X = dust56.velocity.X * 0.5f;
            Dust? dust57 = Main.dust[num1225];
        ...
        if (Main.rand.Next(40) == 0)
        {
            ...
            Dust? dust58 = Main.dust[num1226];
            dust58.velocity.X = dust58.velocity.X * 0.5f;
            Dust? dust59 = Main.dust[num1226];
