...
public class ArmageddonSlime : ModNPC
{
    ...
    public override void SetDefaults()
    {
        ...
        NPC.BossBar = ModContent.GetInstance<BossBars.ArmageddonSlimeBossBar>();
    ...
    public override void AI()
    {
        ...
        if (NPC.life + num1159 < NPC.ai[3])
        {
            ...
            for (var i = 0; i < cycles; i++)
            {
                ...
                var newNPC = NPC.NewNPC(NPC.GetSource_FromAI(), x2, y2, ModContent.NPCType<DarkMotherSlime>(), 0);
