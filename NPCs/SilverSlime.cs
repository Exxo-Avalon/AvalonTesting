...
public class SilverSlime : ModNPC
{
    ...
    public override void ModifyNPCLoot(NPCLoot loot) => loot.Add(ItemDropRule.Common(ItemID.SilverOre, 1, 15, 25));
    ...
    public override float SpawnChance(NPCSpawnInfo spawnInfo) =>
        ...
        (Main.hardMode || WorldGen.SavedOreTiers.Silver == TileID.Silver)
