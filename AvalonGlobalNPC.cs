...
public class AvalonGlobalNPC : GlobalNPC
{
    ...
    public override void ModifyGlobalLoot(GlobalLoot globalLoot)
    {
        ...
        globalLoot.Add(ItemDropRule.ByCondition(
            ...
            ModContent.ItemType<BloodyWhetstone>(), 160));
        ...
        globalLoot.Add(ItemDropRule.ByCondition(undergroundHardmodeContagionCondition, ItemID.SoulofNight, 5));
        globalLoot.Add(ItemDropRule.ByCondition(hardmodeDungeonCondition, ItemID.CobaltShield, 100));
