    ...
    public override void RightClick(Player player)
    {
        ...
        while (flag4)
        {
            ...
            if (Main.rand.Next(7) == 0)
            {
                ...
                var number20 = Item.NewItem(player.GetSource_OpenItem(Item.type), (int)player.position.X, (int)player.position.Y, player.width, player.height, type13, stack18, false, 0, false);
                if (Main.netMode == NetmodeID.MultiplayerClient)
                {
            ...
            if (Main.rand.Next(7) == 0)
            {
                ...
                var number21 = Item.NewItem(player.GetSource_OpenItem(Item.type), (int)player.position.X, (int)player.position.Y, player.width, player.height, num12, stack19, false, 0, false);
                if (Main.netMode == NetmodeID.MultiplayerClient)
                {
            ...
            if (Main.rand.Next(8) == 0)
            {
                ...
                var number22 = Item.NewItem(player.GetSource_OpenItem(Item.type), (int)player.position.X, (int)player.position.Y, player.width, player.height, num13, num14, false, 0, false);
                if (Main.netMode == NetmodeID.MultiplayerClient)
                {
            ...
            if (Main.rand.Next(7) == 0 && ModContent.GetInstance<AvalonTestingWorld>().SuperHardmode)
            {
                ...
                var number23 = Item.NewItem(player.GetSource_OpenItem(Item.type), (int)player.position.X, (int)player.position.Y, player.width, player.height, num15, stack20, false, 0, false);
                if (Main.netMode == NetmodeID.MultiplayerClient)
                {
        ...
        if (Main.hardMode)
        {
            if (Main.rand.Next(3) == 0)
            {
                ...
                var number24 = Item.NewItem(player.GetSource_OpenItem(Item.type), (int)player.position.X, (int)player.position.Y, player.width, player.height, num16, stack21, false, 0, false);
                if (Main.netMode == NetmodeID.MultiplayerClient)
                {
