...
class SuperRestorationPotion : ModItem
{
    ...
    {
        Recipe.Create(Type)
            .AddIngredient(ModContent.ItemType<GreaterRestorationPotion>())
        ...
        Recipe.Create(Type)
            .AddIngredient(ModContent.ItemType<GreaterRestorationPotion>())
            .AddIngredient(ModContent.ItemType<Material.SoulofBlight>())
            .AddIngredient(ModContent.ItemType<Material.TwilightPlume>())
            .AddIngredient(ItemID.PinkGel, 6)
            .AddTile(TileID.Bottles)
            .Register();
    }
