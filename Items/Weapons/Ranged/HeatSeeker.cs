...
class HeatSeeker : ModItem
{
    ...
    {
        Projectile.NewProjectile(source, position.X, position.Y, velocity.X, velocity.Y, ModContent.ProjectileType<Projectiles.HomingRocketFriendly>(), damage, knockback, player.whoAmI, 0f, 0f);
        return false;
    }
}
