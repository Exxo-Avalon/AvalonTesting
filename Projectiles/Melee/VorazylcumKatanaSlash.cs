...
{
    public override Color SparkleColor => new Color(200, 80, 120, 0);
    public override Color BigSparkleColor => new Color(200, 80, 120, 0);
    ...
    public override float scalemod => 1.1f;
