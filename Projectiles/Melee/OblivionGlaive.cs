...
public class OblivionGlaive : ModProjectile
{
    ...
    public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
    {
        ...
        int p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), spawnPosition.X, spawnPosition.Y, velocity.X, velocity.Y, ModContent.ProjectileType<Projectiles.Melee.OblivionGlaiveSky>(), damage, knockback, Projectile.owner, 0f);
