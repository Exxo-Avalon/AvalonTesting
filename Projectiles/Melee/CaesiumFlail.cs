...
{
    // Example Advanced Flail is a complete adaptation of Ball O' Hurt projectile. The code has been rewritten a bit to make it easier to follow. Compare this code against the decompiled Terraria code for an example of adapting vanilla code. A few comments and extra code snippets show features from other vanilla flails as well.
    ...
    {
        private const string ChainTexturePath = "Avalon/Projectiles/Melee/CaesiumFlail_Chain"; // The folder path to the flail chain sprite
