...
{
    private const string ChainTexturePath = "Avalon/Projectiles/Melee/Cell_Chain"; // The folder path to the flail chain sprite
    private const string ChainTextureExtraPath = "Avalon/Projectiles/Melee/Cell_Chain";  // This texture and related code is optional and used for a unique effect
