...
public class Cell : ModProjectile
{
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Asset<Texture2D> chainTexture = ModContent.Request<Texture2D>("Avalon/Projectiles/Melee/Cell_Chain");
        Asset<Texture2D> chainTextureExtra = ModContent.Request<Texture2D>("Avalon/Projectiles/Melee/Cell_Chain"); // This texture and related code is optional and used for a unique effect
