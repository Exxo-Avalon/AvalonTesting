    ...
    public override bool OnTileCollide(Vector2 oldVelocity)
    {
        if (Projectile.type == ModContent.ProjectileType<SacredLyreSplittingNote>())
        {
            ...
            for (int num133 = 0; num133 < 3; num133++)
            {
                ...
                int proj = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + num134, Projectile.position.Y + num135, num134, num135, ProjectileID.CrystalShard, (int)(Projectile.damage * 0.65f), 0f, Projectile.owner, 0f, 0f);
