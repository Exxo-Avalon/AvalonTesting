...
public class Soul : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        {
            float x2 = Projectile.Center.X - Projectile.velocity.X / 10f * num26;
            float y2 = Projectile.Center.Y - Projectile.velocity.Y / 10f * num26;
            int num27 = Dust.NewDust(new Vector2(x2, y2), 16, 16, DustID.DungeonSpirit, 0f, 0f, 0, default, 1f);
