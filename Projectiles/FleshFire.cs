...
public class FleshFire : ModProjectile
{
    ...
    {
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), new Vector2(Projectile.Center.X, Projectile.Center.Y), new Vector2(0f, 0f), ModContent.ProjectileType<Projectiles.FleshFireLinger>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
        return true;
    }
