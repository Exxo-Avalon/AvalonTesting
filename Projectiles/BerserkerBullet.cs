...
public class BerserkerBullet : ModProjectile
{
    ...
    public override void Kill(int timeLeft)
    {
        ...
        for (int num133 = 0; num133 < 3; num133++)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + num134, Projectile.position.Y + num135, num134, num135, ModContent.ProjectileType<BerserkerCrystal>(), (int)((double)Projectile.damage * 0.5), 0f, Projectile.owner, 0f, 0f);
        }
    }
