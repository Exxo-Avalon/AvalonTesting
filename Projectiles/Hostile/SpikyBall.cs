    ...
    public override void AI()
    {
        ...
        if (Projectile.ai[0] >= 240)
        {
            ...
            if (Projectile.ai[0] % 10 == 0)
            {
                ...
                {
                    p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(rotation - Projectile.ai[1]) * speed) * -1), (float)((Math.Sin(rotation - Projectile.ai[1]) * speed) * -1), ModContent.ProjectileType<Spike>(), 60, 0f);
                    ...
                    p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(rotation2 - Projectile.ai[1]) * speed) * -1), (float)((Math.Sin(rotation2 - Projectile.ai[1]) * speed) * -1), ModContent.ProjectileType<Spike>(), 60, 0f);
                    Main.projectile[p].timeLeft = 600;
                    Main.projectile[p].friendly = false;
                    Main.projectile[p].hostile = true;
                    Main.projectile[p].tileCollide = false;
                    ...
                    p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(rotation3 - Projectile.ai[1]) * speed) * -1), (float)((Math.Sin(rotation3 - Projectile.ai[1]) * speed) * -1), ModContent.ProjectileType<Spike>(), 60, 0f);
                    Main.projectile[p].timeLeft = 600;
                    Main.projectile[p].friendly = false;
                    Main.projectile[p].hostile = true;
                    Main.projectile[p].tileCollide = false;
                    ...
                    p = Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center.X, Projectile.Center.Y, (float)((Math.Cos(rotation4 - Projectile.ai[1]) * speed) * -1), (float)((Math.Sin(rotation4 - Projectile.ai[1]) * speed) * -1), ModContent.ProjectileType<Spike>(), 60, 0f);
                    Main.projectile[p].timeLeft = 600;
                    Main.projectile[p].friendly = false;
                    Main.projectile[p].hostile = true;
                    Main.projectile[p].tileCollide = false;
