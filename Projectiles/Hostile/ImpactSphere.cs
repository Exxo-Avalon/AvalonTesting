        ...
        if (Projectile.type == ModContent.ProjectileType<ImpactSphere>())
        {
            ...
            if (flag22)
            {
                ...
                if (Projectile.localAI[0] > 14f)
                {
                    ...
                    num607 *= num609;
                    num608 *= num609;
                    var num610 = Projectile.NewProjectile(Projectile.GetSource_FromThis(), value8.X, value8.Y, num607, num608, ModContent.ProjectileType<ImpactBolt>(), Projectile.damage, Projectile.knockBack, Projectile.owner, 0f, 0f);
