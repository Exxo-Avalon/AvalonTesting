...
public class DesertBeakSandstorm : ModProjectile
{
    ...
    {
        DisplayName.SetDefault("Beak's Sandstorm");
    }
    ...
    public override void AI()
    {
        ...
        //    {
        //        if (Vector2.Distance(new Vector2(Projectile.Center.X, Projectile.position.Y), new Vector2(x, y)) < radius)
        //        {
        //            if (Main.rand.NextBool(8))
        //            {
        //                int D2 = Dust.NewDust(new Vector2(x, y), 0, 0, DustID.Sandnado, 0, 0, 100, new Color(), 1.5f);
        //                Main.dust[D2].noGravity = true;
        //                Main.dust[D2].fadeIn = 0.5f;
