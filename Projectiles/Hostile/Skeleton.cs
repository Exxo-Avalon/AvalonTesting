...
public class Skeleton : ModProjectile
{
    ...
    {
        NPC.NewNPC(Projectile.GetSource_FromThis(), (int)Projectile.position.X, (int)Projectile.position.Y, ModContent.NPCType<NPCs.IrateBones>());
    }
