                ...
                if (item.useStyle == ItemUseStyleID.Shoot)
                {
                    ...
                    if (flag14)
                    {
                        ...
                        DrawData value = new DrawData(texture,
                            ...
                            c, num104, zero3, item.scale, drawInfo.itemEffect, 0);
                    ...
                    else
                    {
                        ...
                        DrawData value = new DrawData(texture, new Vector2((int)(value2.X - Main.screenPosition.X + vector10.X), (int)(value2.Y - Main.screenPosition.Y + vector10.Y)), new Microsoft.Xna.Framework.Rectangle?(new Rectangle(0, 0, TextureAssets.Item[item.type].Value.Width, TextureAssets.Item[item.type].Value.Height)), Color.White, drawPlayer.itemRotation, origin5, item.scale, drawInfo.itemEffect, 0);
                        drawInfo.DrawDataCache.Add(value);
                    }
                }
                else
