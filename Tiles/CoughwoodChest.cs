...
public class CoughwoodChest : ModTile
{
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        {
            player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Coughwood Chest";
            if (player.cursorItemIconText == "Coughwood Chest")
            {
                player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Storage.CoughwoodChest>();
