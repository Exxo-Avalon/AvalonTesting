...
public class PlatinumChest : ModTile
{
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        {
            player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Platinum Chest";
            if (player.cursorItemIconText == "Platinum Chest")
            {
                player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Storage.PlatinumChest>();
