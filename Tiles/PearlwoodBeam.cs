...
public class PearlwoodBeam : ModTile
{
    ...
    public int CanPlaceAlter(int i, int j, int type, int style, int direction, int alt)
    {
        return 1;
    }
    public static int AfterPlacement(int i, int j, int type, int style, int direction, int alt)
    {
