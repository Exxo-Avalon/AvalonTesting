...
public class HumidityCandle : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        DustType = ModContent.DustType<SoulofHumidity>();
    }
    ...
    public override void HitWire(int i, int j)
    {
        ...
        NetMessage.SendTileSquare(-1, i, topY + 1, 1);
    }
    ...
    public override void NearbyEffects(int i, int j, bool closer)
    {
        ...
        {
            int num162 = Dust.NewDust(new Vector2(i * 16, j * 16), 16, 16, ModContent.DustType<SoulofHumidity>());
    ...
    public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
    {
        ...
        for (int k = 0; k < 7; k++)
        {
            ...
            Main.spriteBatch.Draw(Mod.Assets.Request<Texture2D>("Tiles/SoulCandles/HumidityCandle_Flame").Value,
                new Vector2((i * 16) - (int)Main.screenPosition.X + offsetX - ((width - 16f) / 2f) + x,
                    (j * 16) - (int)Main.screenPosition.Y + y) + zero, new Rectangle(frameX, frameY, width, height),
