...
public class EctoplasmDoorOpen : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        CloseDoorID = ModContent.TileType<EctoplasmDoorClosed>();
    ...
    {
        Item.NewItem(WorldGen.GetItemSource_FromTileBreak(i, j), i * 16, j * 16, 32, 48, ModContent.ItemType<EctoplasmDoor>());
    }
