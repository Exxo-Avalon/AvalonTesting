...
public class DarkSlimeChest : ModTile
{
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        {
            player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Dark Slime Chest";
            if (player.cursorItemIconText == "Dark Slime Chest")
            {
                player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Storage.DarkSlimeChest>();
