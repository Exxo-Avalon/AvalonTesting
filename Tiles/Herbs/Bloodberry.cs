...
public class Bloodberry : ModTile
{
    ...
    public override bool Drop(int i, int j)
    {
        ...
        {
            Item.NewItem(WorldGen.GetItemSource_FromTileBreak(i, j),new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<BloodberrySeeds>(), Main.rand.Next(3) + 1);
            Item.NewItem(WorldGen.GetItemSource_FromTileBreak(i, j),new Vector2(i, j).ToWorldCoordinates(), ModContent.ItemType<Items.Material.Bloodberry>(), 1);
        }
