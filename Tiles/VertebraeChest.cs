...
public class VertebraeChest : ModTile
{
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        {
            player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Vertebrae Chest";
            if (player.cursorItemIconText == "Vertebrae Chest")
            {
                player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Storage.VertebraeChest>();
