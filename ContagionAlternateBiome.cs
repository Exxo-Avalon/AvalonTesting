...
using Terraria;
using System;
>>>>>>> 7778d07fdf779524bf000d688f3be0d0843680fd
...
<<<<<<< HEAD
        public override EvilBiomeGenerationPass GetEvilBiomeGenerationPass() => new ContagionPass();
...
<<<<<<< HEAD
        ...
        private class ContagionPass : EvilBiomeGenerationPass
        {
            ...
            public override void GenerateEvil(int evilBiomePosition, int evilBiomePositionWestBound, int evilBiomePositionEastBound)
            {
                ContagionRunner(evilBiomePosition, (int)WorldGen.worldSurfaceLow - 10);
                /*for (int x = leftBeachAvoidanceCheck; x < rightBeachAvoidanceCheck; x++)
                {
