...
namespace Avalon.World.Passes
{
    class SnowHardMode
    {
        ...
        public static void IceSnowOreRunner(int i, int j, double strength, int steps, ushort type)
        {
            ...
            value.Y = j;
            Vector2 value2;
            value2.X = WorldGen.genRand.Next(-10, 11) * 0.1f;
            value2.Y = WorldGen.genRand.Next(-10, 11) * 0.1f;
