...
class OreGenPreHardMode
{
    public static void Method(GenerationProgress progress, GameConfiguration configuration)
    {
        ...
        // prehardmode ores
        for (int num559 = 0; num559 < (int)(Main.maxTilesX * Main.maxTilesY * 6E-05); num559++)
        {
        ...
        for (int num560 = 0; num560 < (int)(Main.maxTilesX * Main.maxTilesY * 8E-05); num560++)
        {
        ...
        for (int num561 = 0; num561 < (int)(Main.maxTilesX * Main.maxTilesY * 0.0002); num561++)
        {
