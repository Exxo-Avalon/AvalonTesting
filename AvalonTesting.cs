...
public class AvalonTesting : Mod
{
    ...
    public override void Load()
    {
        if (Main.netMode != NetmodeID.Server)
        {
            ...
            TextureAssets.Tile[TileID.SilverCoinPile] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/SilverCoin");
            TextureAssets.Tile[TileID.GoldCoinPile] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/GoldCoin");
            TextureAssets.Tile[TileID.PlatinumCoinPile] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/PlatinumCoin");
            TextureAssets.Item[ItemID.PaladinBanner] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/PaladinBanner");
            TextureAssets.Item[ItemID.PossessedArmorBanner] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/PossessedArmorBanner");
            TextureAssets.Item[ItemID.BoneLeeBanner] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/BoneLeeBanner");
            TextureAssets.Item[ItemID.AngryTrapperBanner] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/AngryTrapperBanner");
            TextureAssets.Item[ItemID.Deathweed] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/Deathweed");
            TextureAssets.Item[ItemID.WaterleafSeeds] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/WaterleafSeeds");
            TextureAssets.Projectile[ProjectileID.MagicDagger] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/MagicDagger");
            TextureAssets.Tile[TileID.Banners] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/VanillaBanners");
            TextureAssets.Tile[TileID.Containers] = ModContent.Request<Texture2D>("AvalonTesting/Sprites/VanillaChests");
        }
    }
}
