...
namespace Avalon.UI
{
    class StaminaBar : UIState
    {
        ...
        public StaminaBar()
        {
            staminaTexture1 = ModContent.Request<Texture2D>("Avalon/Sprites/Stamina").Value;
            staminaTexture2 = ModContent.Request<Texture2D>("Avalon/Sprites/Stamina2").Value;
            staminaTexture3 = ModContent.Request<Texture2D>("Avalon/Sprites/Stamina3").Value;
