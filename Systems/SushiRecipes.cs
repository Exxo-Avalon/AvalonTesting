...
public static class SushiRecipes
{
    ...
    // Recipe.Create doesn't work as a replacement for self.CreateRecipe
        ...
        Recipe.Create(ModContent.ItemType<Items.Accessories.GoldenShield>()).AddIngredient(imk.Find<ModItem>("PostMechanicalBossLootToken").Type, 20).AddTile(ModContent.TileType<Tiles.SolariumAnvil>()).Register();
        Recipe.Create(ModContent.ItemType<Items.Accessories.GreekExtinguisher>()).AddIngredient(imk.Find<ModItem>("PostMechanicalBossLootToken").Type, 20).AddTile(ModContent.TileType<Tiles.SolariumAnvil>()).Register();
        Recipe.Create(ModContent.ItemType<Items.Accessories.SixHundredWattLightbulb>()).AddIngredient(imk.Find<ModItem>("PostPlanteraLootToken").Type, 20).AddTile(ModContent.TileType<Tiles.SolariumAnvil>()).Register();
        Recipe.Create(ModContent.ItemType<Items.Accessories.Vortex>()).AddIngredient(imk.Find<ModItem>("PostMechanicalBossLootToken").Type, 20).AddTile(ModContent.TileType<Tiles.SolariumAnvil>()).Register();
