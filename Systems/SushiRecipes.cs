...
public static class SushiRecipes
{
    ...
    // Recipe.Create doesn't work as a replacement for self.CreateRecipe
        ...
        Recipe.Create(ModContent.ItemType<Items.Accessories.BandofStamina>()).AddIngredient(ModContent.ItemType<Items.Tokens.ContagionToken>(), 20).AddTile(TileID.TinkerersWorkbench).Register();
        ...
        Recipe.Create(ModContent.ItemType<Items.Other.SnotOrb>()).AddIngredient(ModContent.ItemType<Items.Tokens.ContagionToken>(), 20).AddTile(TileID.TinkerersWorkbench).Register();
        Recipe.Create(ModContent.ItemType<Items.Weapons.Ranged.PeeShooter>()).AddIngredient(ModContent.ItemType<Items.Tokens.ContagionToken>(), 20).AddTile(TileID.TinkerersWorkbench).Register();
        ...
        Recipe.Create(ModContent.ItemType<Items.Accessories.GoldenShield>()).AddIngredient(ModContent.ItemType<Items.Tokens.SuperhardmodeToken>(), 20).AddTile(ModContent.TileType<Tiles.SolariumAnvil>()).Register();
        Recipe.Create(ModContent.ItemType<Items.Accessories.GreekExtinguisher>()).AddIngredient(ModContent.ItemType<Items.Tokens.SuperhardmodeToken>(), 20).AddTile(ModContent.TileType<Tiles.SolariumAnvil>()).Register();
        Recipe.Create(ModContent.ItemType<Items.Accessories.SixHundredWattLightbulb>()).AddIngredient(ModContent.ItemType<Items.Tokens.SuperhardmodeToken>(), 20).AddTile(ModContent.TileType<Tiles.SolariumAnvil>()).Register();
        Recipe.Create(ModContent.ItemType<Items.Accessories.Vortex>()).AddIngredient(ModContent.ItemType<Items.Tokens.SuperhardmodeToken>(), 20).AddTile(ModContent.TileType<Tiles.SolariumAnvil>()).Register();
